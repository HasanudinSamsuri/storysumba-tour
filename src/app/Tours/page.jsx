...
import { faLocationDot, faAngleDown, faAngleUp, faAngleRight } from "@fortawesome/free-solid-svg-icons";
...
export default function page() {
  return (
    <>
      ...
      {/* Tours */}
        <div className="travel px-[2%] sm:px-[8%] lg:px-[12%] py-20 lg:py-[120px] flex flex-col gap-10 lg:gap-14">
            <div className="travel-content text-center">
                <h1 className="unbounded-font text-4xl font-semibold pb-3">Temukan Pilihan Perjalanan Terbaik di Pulau Sumba</h1>
                <p className="w-[60%] mx-auto text-[#193555]">Lebih dari 10 destinasi terbaik di pulau ini yang wajib anda kunjungi, pilihlah paket perjalanan terbaik anda
                </p>
            </div>
